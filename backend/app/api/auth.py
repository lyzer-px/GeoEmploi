...
from app.schemas.auth import AccessToken, Token, RefreshTokenRequest
...
def login_user(
    user_data: UserIn, user_service: UserServiceDep
):
...
def create_user(
    new_user: UserCreate, user_service: UserServiceDep
):
...
def refresh_access_token(
    ...
    access_payload = AuthenticationService.create_access_token_payload(user.email, user_service)
